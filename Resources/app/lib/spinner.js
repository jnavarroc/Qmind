 ...
 * @param {Object} params
 */
var activitySpinner = function(text) {
	...
	if (_isAndroid) {
		_style = Ti.UI.ActivityIndicatorStyle.DARK;
	} else {
		_style = Ti.UI.iPhone.ActivityIndicatorStyle.DARK;
	}
...
activitySpinner.prototype.show = function() {
	this.infoWindow.open();
	this.activityIndicator.show();
};
activitySpinner.prototype.hide = function() {
	this.activityIndicator.hide();
	this.infoWindow.close();
};

module.exports = activitySpinner;
